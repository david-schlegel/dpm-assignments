...
The color scheme is intentionally selected to be easily distinguishable and to ensure that colors representing stress levels are distinct, avoiding any potential confusion. The stress level colors transition from 'warm' for lower stress to 'cold' for higher stress, aiding in quick visual differentiation.
